...
/**
 * Modern Member/Student Dashboard coordinator for the Library Management
 * System.
 * Coordinates personalized views, KPI metrics, tab switching, and modular
 * sub-panels.
 */
public class MemberDashboard extends JFrame {
    ...
    private void buildUI() {
        ...
        UITheme.styleTabbedPane(mainTabs);
    ...
    private JPanel createHeaderPanel() {
        ...
        userBadgeNameLabel.setForeground(UITheme.PRIMARY_TEXT);
    ...
    private JPanel createKpiPanel() {
        ...
        kpiMemberSinceVal = new JLabel(
                member.getMembershipDate() != null ? member.getMembershipDate().toString() : "-");

        container.add(createKpiCard("My Borrowed Books", kpiBorrowedVal, "📚", UITheme.PRIMARY_TEXT));
    ...
    public void refreshKpiCards() {
        ...
        if (kpiBorrowedVal != null)
            kpiBorrowedVal.setText(String.valueOf(myActiveCount));
        if (kpiAvailableVal != null)
            kpiAvailableVal.setText(String.valueOf(availableBooksCount));
        ...
        if (kpiStatusVal != null)
            kpiStatusVal.setText(member.getStatus() != null ? member.getStatus().name() : "ACTIVE");
        if (kpiMemberSinceVal != null)
            kpiMemberSinceVal.setText(member.getMembershipDate() != null ? member.getMembershipDate().toString() : "-");
    }
